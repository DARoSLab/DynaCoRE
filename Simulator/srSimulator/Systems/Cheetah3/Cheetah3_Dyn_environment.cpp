#include "Cheetah3_Dyn_environment.h"
#include <iostream>
...
#include <DynaController/Cheetah3_Controller/Cheetah3_interface.hpp>
#include <DynaController/Cheetah3_Controller/Cheetah3_DynaCtrl_Definition.h>
#include <RobotSystems/Cheetah3/Cheetah3_Definition.h>

#include <srTerrain/Ground.h>
#include <srConfiguration.h>

Cheetah3_Dyn_environment::Cheetah3_Dyn_environment():
    ang_vel_(3)
{
    /********** Space Setup **********/
    m_Space = new srSpace();
    ...
    robot_->BuildRobot(Vec3 (0., 0., 0.), 
            srSystem::FIXED, srJoint::TORQUE, ModelPath"Cheetah3/cheetah3.urdf");
    m_Space->AddSystem((srSystem*)robot_);

    /******** Interface set ********/
    //interface_ = new Cheetah3_interface();
    //data_ = new Cheetah3_SensorData();
    //cmd_ = new Cheetah3_Command();
    ...
    printf("[Cheetah3 Dynamic Environment] Build Dynamic Environment\n");
}

void Cheetah3_Dyn_environment::ControlFunction( void* _data ) {
    static int count(0);
    ++count;

    Cheetah3_Dyn_environment* pDyn_env = (Cheetah3_Dyn_environment*)_data;
    Cheetah3* robot = (Cheetah3*)(pDyn_env->robot_);
    //Cheetah3_SensorData* p_data = pDyn_env->data_;
...
void Cheetah3_Dyn_environment::Rendering_Fnc(){}
void Cheetah3_Dyn_environment::_Get_Orientation(dynacore::Quaternion & rot){
    SO3 so3_body =  robot_->
...
void Cheetah3_Dyn_environment::_CheckFootContact(bool & r_contact, bool & l_contact){
...
void Cheetah3_Dyn_environment::getIMU_Data(std::vector<double> & imu_acc,
