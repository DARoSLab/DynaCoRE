#include "MiniCheetah_Dyn_environment.h"
#include <iostream>
...
//#include <DynaController/MiniCheetah_Controller/MiniCheetah_interface.hpp>
//#include <DynaController/MiniCheetah_Controller/MiniCheetah_DynaCtrl_Definition.h>
//#include <RobotSystems/MiniCheetah/MiniCheetah_Definition.h>
    ...
    ang_vel_(3)
{
    ...
    //->GetPosition()<<std::endl;;
    printf("[MiniCheetah Dynamic Environment] Build Dynamic Environment\n");
}

void MiniCheetah_Dyn_environment::ControlFunction( void* _data ) {
    static int count(0);
    ++count;

    MiniCheetah_Dyn_environment* pDyn_env = (MiniCheetah_Dyn_environment*)_data;
    MiniCheetah* robot = (MiniCheetah*)(pDyn_env->robot_);
    //MiniCheetah_SensorData* p_data = pDyn_env->data_;
...
void MiniCheetah_Dyn_environment::Rendering_Fnc(){
}
void MiniCheetah_Dyn_environment::_Get_Orientation(dynacore::Quaternion & rot){
    SO3 so3_body =  robot_->
...
void MiniCheetah_Dyn_environment::_CheckFootContact(bool & r_contact, bool & l_contact){
...
void MiniCheetah_Dyn_environment::getIMU_Data(std::vector<double> & imu_acc,
