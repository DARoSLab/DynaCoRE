#include "Manipulator_Dyn_environment.h"
#include <iostream>
...
//#include <DynaController/Manipulator_Controller/Manipulator_interface.hpp>
//#include <DynaController/Manipulator_Controller/Manipulator_DynaCtrl_Definition.h>
//#include <RobotSystems/Manipulator/Manipulator_Definition.h>

#include <srTerrain/Ground.h>
#include <srConfiguration.h>

Manipulator_Dyn_environment::Manipulator_Dyn_environment():
    ang_vel_(3)
{
    /********** Space Setup **********/
    m_Space = new srSpace();
    ...
    /********** Robot Set  **********/
    robot_ = new Manipulator();
    robot_->BuildRobot(Vec3 (0., 0., 0.), 
            srSystem::FIXED, srJoint::TORQUE, ModelPath"Manipulator/3dof_manipulator.urdf");
    m_Space->AddSystem((srSystem*)robot_);

    /******** Interface set ********/
    //interface_ = new Manipulator_interface();
    //data_ = new Manipulator_SensorData();
    //cmd_ = new Manipulator_Command();
    ...
    printf("[Manipulator Dynamic Environment] Build Dynamic Environment\n");
}

void Manipulator_Dyn_environment::ControlFunction( void* _data ) {
    static int count(0);
    ++count;

    Manipulator_Dyn_environment* pDyn_env = (Manipulator_Dyn_environment*)_data;
    Manipulator* robot = (Manipulator*)(pDyn_env->robot_);
    //Manipulator_SensorData* p_data = pDyn_env->data_;
...
void Manipulator_Dyn_environment::Rendering_Fnc(){}
void Manipulator_Dyn_environment::_Get_Orientation(dynacore::Quaternion & rot){
    SO3 so3_body =  robot_->
...
void Manipulator_Dyn_environment::_CheckFootContact(bool & r_contact, bool & l_contact){
...
void Manipulator_Dyn_environment::getIMU_Data(std::vector<double> & imu_acc,
