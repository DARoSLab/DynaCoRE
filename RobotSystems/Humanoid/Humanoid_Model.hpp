#ifndef Humanoid_MODEL
#define Humanoid_MODEL

#include <rbdl/rbdl.h>
#include <RobotSystem.hpp>

class Humanoid_Dyn_Model;
class Humanoid_Kin_Model;

class Humanoid_Model: public RobotSystem{
public:
    Humanoid_Model();
    virtual ~Humanoid_Model();
...
protected:
    Humanoid_Dyn_Model* dyn_model_;
    Humanoid_Kin_Model* kin_model_;
