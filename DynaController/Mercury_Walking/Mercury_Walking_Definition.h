#ifndef MERCURY_WALKING_DEFINITION
#define MERCURY_WALKING_DEFINITION

#include <Mercury/Mercury_Definition.h>

#define MercuryConfigPath THIS_COM"DynaController/Mercury_Walking/MercuryWalkingConfig/"
