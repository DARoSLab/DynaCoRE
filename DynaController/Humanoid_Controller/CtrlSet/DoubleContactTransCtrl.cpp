    ...
    Kd_(humanoid::num_act_joint)
{
    ...
    rfoot_contact_ = new SingleContact(robot_sys_, humanoid_link::rightFoot);
    lfoot_contact_ = new SingleContact(robot_sys_, humanoid_link::leftFoot);
    ...
    wblc_data_->tau_min_ = dynacore::Vector::Constant(humanoid::num_act_joint, -200.);
    wblc_data_->tau_max_ = dynacore::Vector::Constant(humanoid::num_act_joint, 200.);
...
void DoubleContactTransCtrl::CtrlInitialization(const std::string & setting_file_name){
    ini_jpos_ = sp_->Q_.segment(humanoid::num_virtual, humanoid::num_act_joint);
