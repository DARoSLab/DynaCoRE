...
void Reversal_LIPM_Planner::_computeSwitchingState(
  double swing_time,
  const dynacore::Vect3 & com_pos,  const dynacore::Vect3 & com_vel,
...
int Reversal_LIPM_Planner::_check_switch_velocity(const std::vector<dynacore::Vect2> & switch_state){
  int ret(0);
...
void Reversal_LIPM_Planner::_StepLengthCheck(dynacore::Vect3 & target_loc,
...
void Reversal_LIPM_Planner::_StepLengthCheck(dynacore::Vect3 & target_loc, const std::vector<dynacore::Vect2> & switch_state){
  // X limit check
